...
const OtpVerifyClient = () => {
    ...
    return (
        <div>
            ...
            <p className="text-[#818181] w-[386px] text-center mx-auto text-[16px] leading-[25px] font-normal ">
                We sent a reset link to <span className="text-[#636363]">contact@dscode...com</span>  enter 5 digit code that
