        ...
        <div className='bg-[#E6F2F5] pt-20'>
            ...
            <div className='container  grid grid-cols-3 gap-6 pb-20'>
                ...
                <div className='relative bg-white group w-[319px] h-[220px] rounded-2xl mx-auto flex items-center justify-center'>
                    ...
                    {/* info container */}
                    <div>
                        <Heading name="Location" style="font-medium text-[24px] leading-[29px] text-primary"/>
                        <p className='text-[#7676761] text-[14px] leading-[21px] font-normal'>Al. Brucknera Aleksandra 63, <br /> Wrocław 51-410</p>
                    </div>
                </div>
                ...
                <div className='relative bg-white w-[319px] group h-[220px] rounded-2xl mx-auto flex items-center justify-center'>
                    ...
                    {/* info container */}
                    <div>
                        <Heading name="Email" style="font-medium text-[24px] leading-[29px] text-primary"/>
                        <p className='text-[#7676761] text-[14px] leading-[21px] font-normal'>email@gmail.com</p>
                    </div>
                </div>
                ...
                <div className='relative group bg-white w-[319px] h-[220px] rounded-2xl mx-auto flex items-center justify-center'>
                    ...
                    {/* info container */}
                    <div>
                        <Heading name="Get In Touch!" style="font-medium text-[24px] leading-[29px] text-primary"/>
                        <p className='text-[#7676761] text-[14px] leading-[21px] font-normal'>+35 5231445</p>
                    </div>
                </div>
