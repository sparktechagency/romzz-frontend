...
const DetailsClient = ({ id }: { id: string }) => {
  ...
  return (
    <div className="container pt-6 mb-8">
      ...
      <Heading
        name="Looking for a room in Sydney"
        ...
        <div className="col-span-12 lg:col-span-5 relative order-1 lg:order-2 bg-[#F3F3F3] p-2 rounded-lg">
          ...
          <div className="flex items-center justify-between border border-[#E0E0E0] bg-white rounded-3xl p-2 mb-2">
            ...
            <div
              ...
              className="w-10 h-10 rounded-full bg-[#E6F2F5] flex items-center justify-center"
            >
      ...
      <div className="rounded-lg bg-[#F3F3F3] p-6 mt-6 ">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-8 order-2 lg:order-1">
            ...
            <p className="text-[#767676] text-[16px] leading-6 font-normal">
              amet, ex Ut adipiscing sodales. massa placerat. Sed eget fringilla
              gravida nisi Donec eu eu tempor nulla, nulla, leo. faucibus
              tortor. Donec libero, elementum tincidunt id tincidunt dui
              faucibus turpis consectetur amet, nibh luctus nibh lacus, ex
              hendrerit fringilla fringilla est. lacus Nunc tincidunt dignissim,
              id nec Lorem dui Sed nibh id elementum non tincidunt
            </p>
        ...
        <div className="col-span-12 mt-6 flex lg:flex-row flex-col lg:items-center lg:gap-10 gap-3 ">
          <p className="text-[#5C5C5C] leading-6 font-medium text-[16px]">
            Move on : <span className="text-[#00B047]">Instant</span>{" "}
          </p>
          <p className="text-[#5C5C5C] leading-6 font-medium text-[16px]">
            Gender : <span className="text-[#00B047]">Male/Female</span>{" "}
          </p>
          <p className="text-[#5C5C5C] leading-6 font-medium text-[16px]">
            Guest type :{" "}
            <span className="text-[#00B047]">Single/Couple/Family</span>{" "}
          </p>
          <p className="text-[#5C5C5C] leading-6 font-medium text-[16px]">
            Occupation : <span className="text-[#00B047]">All</span>{" "}
          </p>
        </div>
