...
const ProfileDetailsClient = () => {
  ...
  useEffect(() => {
    const initialTab =
      new URLSearchParams(window.location.search).get("tab") || "User Details";
    setTab(initialTab);
  }, []);
        ...
        <div className=" flex justify-between items-center border-b-[1px] border-[#C0C0C0] mb-10 w-full ">
            ...
            <ul className="w-full flex items-center gap-6 ">
                ...
                return (
                    ...
                    className={` ${
                        tab === item ? "text-primary" : "text-[#5C5C5C]"
                    }  w-fit relative cursor-pointer text-[16px] leading-6 font-normal pb-3`}
                    >
                    {item}
                    {tab === item && (
                ...
                <li
                    ...
                    className={` ${
                    tab === "Manage Account" ? "text-primary" : "text-[#5C5C5C]"
                    }  w-fit relative cursor-pointer text-[16px] leading-6 font-normal pb-3`}
                >
                    Manage Account
                    {tab === "Manage Account" && (
            ...
            <p className="text-[14px] text-[#5C5C5C] lg:flex w-1/5 text-end gap-1 ">
            {" "}
            <span className="font-normal"> Profile Completed </span>{" "}
