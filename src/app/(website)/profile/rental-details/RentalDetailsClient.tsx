    ...
    return (
        <div>
                    ...
                    [...Array(3)].map((property, index)=>{
                        return(
                            <div key={index} className='bg-white p-2 rounded-lg'>
                                <HostRentCard setOpenRentModal={setOpenRentModal} openRentModal={openRentModal} open={ open} setOpen={setOpen} />
                            </div>
                        )
                    })
                }
            ...
            <Modal
                ...
                open={open}
                setOpen={setOpen}
                body={ <PropertyVerification open={open}  setOpen={setOpen} openRentModal={openRentModal} setOpenRentModal={setOpenRentModal} /> }
                width={852}
            />
