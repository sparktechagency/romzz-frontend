        ...
        <div className='container'>
            ...
            <div className='relative h-[200px]'>
                <Image
                    ...
                    fill
                />
                <div className='w-[430px] absolute left-0 top-1/2 transform -translate-y-1/2 border-2 p-1 rounded-r-[90px] bg-[#E6F2F5] bg-opacity-[80%]'>
                    <div className='flex items-center gap-6'>
                        ...
                        />
                        <div>
                            <Heading name="Aladin" style="font-semibold text-[24px] leading-[36px] text-[#333333]"/>
                            
                            <Rate style={{color:"#FF9773"}} defaultValue={5} />
                            <p className='text-[#767676] text-[14px]  leading-6 font-normal'>R no 1 , Block B, CITY X, USA</p>
                            <p className='text-[#767676] text-[14px]  leading-6 font-normal'>@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
