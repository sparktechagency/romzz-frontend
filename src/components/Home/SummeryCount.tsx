        ...
        <div className='bg-primary h-[193px] flex items-center justify-center'>
            <div className='container flex items-center justify-between'>
                ...
                <div className='flex gap-3'>
                    ...
                    <div>
                        <CountUp end={5}>
                            {({ countUpRef, start } : {countUpRef: any, start:()=>void}) => (
                        ...
                        <p className='text-[18px] leading-[23px] font-normal text-[#F7F7F7]'>Users</p>
                    </div>
                </div>
                ...
                <div className='flex gap-3'>
                    ...
                    <div>
                        ...
                        <p className='text-[18px] leading-[23px] font-normal text-[#F7F7F7]'>Available rentals</p>
                    </div>
                </div>
                ...
                <div className='flex gap-3'>
                    ...
                    <div>
                        ...
                        <p className='text-[18px] leading-[23px] font-normal text-[#F7F7F7]'>Successful Deals</p>
                    </div>
                </div>
                ...
                <div className='flex gap-3'>
                    ...
                    <div>
                        ...
                        <p className='text-[18px] leading-[23px] font-normal text-[#F7F7F7]'>Customer Satisfactions</p>
                    </div>
                </div>
