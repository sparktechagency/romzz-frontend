    ...
    >
      ...
      <Form.Item
        ...
        label={
          <p className="font-medium text-[16px] leading-6 text-[#636363]">
            Proof of ownership{" "}
            <span className="text-[#E88969] font-normal">
              (submit 2 deferent documents)
            </span>{" "}
          </p>
        }
        rules={[
      ...
      <div className="col-span-12 flex items-center gap-2">
        ...
        <p className="font-normal text-[16px] leading-6 text-[#818181]">
          For your safety, double-check the information and provide correct
          information.
        </p>
      </div>
