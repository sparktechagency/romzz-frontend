    ...
    return (
        ...
        >
            <Form.Item
                ...
                label={<p className='font-medium text-[16px] leading-6 text-[#636363]'>Current Password</p>}
                rules={[
                    {
                        required: true,
            ...
            <Form.Item
                name="new_password"
                label={<p className='font-medium text-[16px] leading-6 text-[#636363]'>New Password</p>}
                rules={[
                    {
                        required: true,
