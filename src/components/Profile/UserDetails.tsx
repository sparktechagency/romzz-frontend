    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <Select
                        placeholder={<p className='text-[#818181] text-[14px] font-normal leading-6'>Select Your Gender</p>}
                        style={{
                            height: 48,
                            borderRadius: 24
                        }}
                ...
                <Form.Item
                    name="ine_no"
                    label={<p className='font-medium text-[16px] leading-6 text-[#636363]'>INE No.</p>}
                    style={{marginBottom: 0}}
                    className='col-span-6'
                >
                    <Input
                ...
                <Form.Item
                    ...
                    label={<p className='font-medium text-[16px] leading-6 text-[#636363]'>Present Address</p>}
                    style={{marginBottom: 0}}
                    className='col-span-6'
                >
                    <Input
