        ...
        >
                            ...
                            return(
                                <Link 
                                    ...
                                    className={`
                                        ...
                                        ${menu.path === pathName ? "text-primary font-bold transition-all duration-200" : "text-base font-normal"}
                                    `} 
                                    href={`${menu.path}`}
                                >
                                    {menu.label}
            ...
            <Drawer
                title={<div className='flex items-center justify-between'>
                    ...
                    <X onClick={()=>setOpenDrawer(false)} color='black' className='cursor-pointer' size={26} />
                </div>}
                placement={"left"}
                closable={false}
